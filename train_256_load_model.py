...
model.load_weights('../drive/MyDrive/Ottonomy/best_model_2July_256x256.h5')
...
def scheduler(epoch):
  ...
  return keras.backend.eval(optimizer.lr*0.9999)
...
callbacks = [
    keras.callbacks.ModelCheckpoint('../drive/MyDrive/Ottonomy/best_model_2July_256x256.h5', save_weights_only=True, save_best_only=True, mode='min'),
